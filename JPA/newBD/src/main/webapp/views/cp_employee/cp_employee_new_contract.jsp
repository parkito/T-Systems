                                                ...
                                                <table class="ui-table ui-table-hover ui-table-striped" style="width:100%">
                                                    ...
                                                    <c:forEach var="tariffOption" items="${tariffsList}">
                                                        <tr name="trow" class="ui-table-data-row ui-state-even ui-selected">
                                                            ...
                                                            <td class="simplecell" name="tcell" style="vertical-align: top; width: 150px"><span>${tariffOption.name}</span>
                                                                <br>
                                                            </td>
                                                            <td class="simplecell" name="tcell" style="vertical-align: top; width: 100px;"><span>${tariffOption.price}</span>
                                                            </td>
