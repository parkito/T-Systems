window.CM = {
    ...
    menu: {
        init: function () {
            ...
            $('.cm-submenu ul').click(function (e) {
                e.stopPropagation()
            });
    ...
    swiper: {
        init: function () {
            ...
            $(triggers).bind('touchstart', function (e) {
                $(this).addClass('active');
                return false;
            });
            $(triggers).bind('touchmove', function (e) {
                return false;
            });
            $(triggers).bind('touchend', function (e) {
                $(this).removeClass('active');
                $(this).click();
                return false;
            });
            $(triggers).bind('touchcancel', function (e) {
                $(this).removeClass('active');
                $(this).click();
                return false;
            });
